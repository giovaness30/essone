...
<form id="groupedform" class="cart grouped_form overflow-auto" style="height:17em" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
...
<button form="groupedform" type="submit" class="single_add_to_cart_button button alt groupedbutton" style=""><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
